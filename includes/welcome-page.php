	...
	echo '<div class="tpgb-panel-row">';
		echo '<div class="tpgb-panel-col tpgb-panel-col-35">';
			...
			echo '<div class="tpgb-welcome-user-info tpgb-p-20 tpgb-mb-8">';
				...
				echo '</ul>';
				/*echo '<a href="#" class="tpgb-panel-btn-outline tpgb-text-white" title="'.esc_attr__('Free Vs Pro','tpgb').'" target="_blank">'.esc_html__('Free Vs Pro','tpgb').'</a>';
			...
			echo '<div class="tpgb-panel-sec tpgb-welcome-doc tpgb-p-20 tpgb-mt-8 tpgb-mb-8">';
				...
				echo '<a href="https://docs.posimyth.com/tpag/" class="tpgb-panel-btn" title="'.esc_attr__('Read Documentation','tpgb').'" target="_blank">'.esc_html__('Read Documentation','tpgb').'</a>';
			echo '</div>';
			/*Welcome Document*/
			...
			echo '<div class="tpgb-panel-sec tpgb-welcome-sys-req tpgb-p-20 tpgb-mt-8">';
				...
				/*echo '<a href="#" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Know More & Resolve','tpgb').'" target="_blank">'.esc_html__('Know More & Resolve?','tpgb').'</a>';*/
		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('16 December 2020','tpgb').' <span class="changelog-version">'.esc_html__('1.0.4','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Fix : Nested blocks dynamic assets loading bug fix','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('14 December 2020','tpgb').' <span class="changelog-version">'.esc_html__('1.0.3','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Update : Performance improvement for plugin used without any blocks used','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('14 December 2020','tpgb').' <span class="changelog-version">'.esc_html__('1.0.2','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Update : Compatibility with .alignfull & .alignwide classes of Gutenberg','tpgb').'</li>';
						echo '<li>'.esc_html__('Update : Static CSS for Default Column Width Values','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('11 December 2020','tpgb').' <span class="changelog-version">'.esc_html__('1.0.1','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Fix : Advance Tab Styling Fixed (Each Block)','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Creative Image : Margin CSS Fixed','tpgb').'</li>';
						echo '<li>'.esc_html__('Fix : Infobox Style 3 : Margin CSS Fixed','tpgb').'</li>';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-faq tpgb-mt-8">';
				...
				echo '<div class="tpgb-faq-section">';
					...
					echo '<div class="faq-content">'.sprintf( __( 'You can have a look at <a href="%1$s" target="_blank" class="panel-sec-color">our documentation</a> get <a href="%2$s" target="_blank" class="panel-sec-color">Free support</a> using WordPress.org, and/or Join our <a href="%3$s" target="_blank" class="panel-sec-color">Facebook channel</a> to get help from community.', 'tpgb' ), 'https://docs.posimyth.com/tpag/','https://wordpress.org/support/plugin/the-plus-addons-for-block-editor/','https://www.facebook.com/groups/theplus4gutenberg/' ).'</div>';
				echo '</div>';
				echo '<div class="tpgb-faq-section">';
				...
				echo '</div>';
				echo '<a href="#" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('More FAQs','tpgb').'" target="_blank">'.esc_html__('More FAQs','tpgb').'</a>';
			echo '</div>';
			/*Welcome FAQ*/
		echo '</div>';
	echo '</div>';
		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-100">';
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-video">';
				...
				echo '<div class="tpgb-panel-row tpgb-panel-relative">';
					echo '<a href="#" class="tpgb-more-video" target="_blank">'.esc_html__("Our Full Playlist",'tpgb').'</a>';
					echo '<div class="tpgb-panel-col tpgb-panel-col-25">';
						echo '<a href="#" class="tpgb-panel-video-list" target="_blank">';
	...
	echo '<div class="tpgb-panel-row tpgb-mt-8 tp-mt-8-remove">';
		echo '<div class="tpgb-panel-col tpgb-panel-col-50" style="align-content: flex-start;">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-mb-8 tpgb-welcome-tech-sup">';
				...
				echo '<div class="tpgb-sec-border"></div>';
				echo '<div class="tpgb-sec-desc">'.esc_html__('Tried everything but not found a solution? Our support team is always there for your backup. Just a few quick details to ','tpgb').'<a href="https://docs.posimyth.com/tpag/steps-to-follow-before-submitting-a-support-ticket/" target="_blank" class="panel-sec-color">'.esc_html__('check at here before submitting ticket.','tpgb').'</a>'.esc_html__(' You may read our ','tpgb').'<a href="#" target="_blank" class="panel-sec-color">'.esc_html__('Support Policy','tpgb').'</a>'. esc_html__(' to find out, Which things are covered.','tpgb').'</div>';
				...
				echo '<a href="http://m.me/tpagutenberg/" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Live Chat','tpgb').'" target="_blank">'.esc_html__('Live Chat','tpgb').'</a>';
				echo '<a href="https://wordpress.org/support/plugin/the-plus-addons-for-block-editor/" class="tpgb-panel-btn-outline-2 tpgb-mt-8" title="'.esc_attr__('Free Support','tpgb').'" target="_blank">'.esc_html__('Free Support','tpgb').'</a>';
			echo '</div>';
			/*technical support*/
			/*Social*/
		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-50">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-mb-8 tpgb-welcome-rate-us">';
				...
				echo '<a href="https://wordpress.org/plugins/the-plus-addons-for-block-editor/#reviews " class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Rate on WordPress','tpgb').'" target="_blank">'.esc_html__('Rate on WordPress','tpgb').'</a>';
				echo '<a href="https://www.facebook.com/tpagutenberg/reviews/" class="tpgb-panel-btn-outline-2 tpgb-mt-8" title="'.esc_attr__('Rate on Facebook','tpgb').'" target="_blank">'.esc_html__('Rate on Facebook','tpgb').'</a>';
			echo '</div>';
			/*Rate Us*/
			/*feedback*/
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-mt-8 tpgb-mb-8 tpgb-welcome-feedback">';
				...
				echo '<a href="http://m.me/tpagutenberg/" class="tpgb-panel-btn tpgb-mt-8" title="'.esc_attr__('Share Feedback','tpgb').'" target="_blank">'.esc_html__('Share Feedback','tpgb').'</a>';
			echo '</div>';
			/*feedback*/
			/*subscriber*/
